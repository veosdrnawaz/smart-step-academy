  ...
  return (
    <section className="py-16 md:py-20 bg-dark relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <h2 className="text-3xl font-bold text-center text-white mb-10 md:mb-12">What Parents Say</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {reviews.map((review, index) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-white/10 to-white/5 p-6 md:p-8 rounded-2xl border border-white/10 backdrop-blur-sm shadow-xl"
            >
              <i className="fa-solid fa-quote-left text-primary text-2xl mb-4 opacity-50"></i>
              <p className="text-gray-300 italic mb-6 text-sm md:text-base">"{review.text}"</p>
              <div>
